...
return Arrays.asList(new Object[][]{
    ...
    @Test
    public void checkTextItemDescription() {

        Main objMain = new Main(driver);

        objMain.scrollClickToFirstItem(numberOfItemsDescription - 1);
        Assert.assertEquals(expected, objMain.getCheckText(numberOfItemsDescription - 1));
        System.out.println("Текст пункта: " + numberOfItemsDescription + ". Ожидается: " + expected + " Фактически: ");
    }
@After
